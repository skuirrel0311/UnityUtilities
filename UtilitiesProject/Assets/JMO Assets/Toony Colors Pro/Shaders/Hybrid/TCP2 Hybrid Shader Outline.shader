...
Shader "Toony Colors Pro 2/Hybrid Shader Outline"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature TCP2_MOBILE
			#pragma shader_feature _ TCP2_RAMPTEXT TCP2_RAMP_CRISP TCP2_RAMP_BANDS TCP2_RAMP_BANDS_CRISP
			#pragma shader_feature TCP2_SHADOW_TEXTURE
			#pragma shader_feature TCP2_SPECULAR
			#pragma shader_feature _ TCP2_SPECULAR_STYLIZED TCP2_SPECULAR_CRISP
			#pragma shader_feature TCP2_RIM_LIGHTING
			#pragma shader_feature TCP2_RIM_LIGHTING_LIGHTMASK
			#pragma shader_feature TCP2_REFLECTIONS
			#pragma shader_feature TCP2_REFLECTIONS_FRESNEL
			#pragma shader_feature TCP2_MATCAP
			#pragma shader_feature TCP2_MATCAP_MASK
			#pragma shader_feature TCP2_OCCLUSION
		...
		Pass
		{
			...
			// -------------------------------------
			// Toony Colors Pro 2 keywords
			#pragma shader_feature _ TCP2_COLORS_AS_NORMALS TCP2_TANGENT_AS_NORMALS TCP2_UV1_AS_NORMALS TCP2_UV2_AS_NORMALS TCP2_UV3_AS_NORMALS TCP2_UV4_AS_NORMALS
			#pragma shader_feature _ TCP2_UV_NORMALS_FULL TCP2_UV_NORMALS_ZW
			#pragma shader_feature _ TCP2_OUTLINE_CONST_SIZE TCP2_OUTLINE_MIN_SIZE
			#pragma shader_feature _ TCP2_OUTLINE_TEXTURED_VERTEX TCP2_OUTLINE_TEXTURED_FRAGMENT
			#pragma shader_feature _ TCP2_OUTLINE_LIGHTING_MAIN TCP2_OUTLINE_LIGHTING_ALL TCP2_OUTLINE_LIGHTING_INDIRECT
			#pragma shader_feature _ TCP2_SHADOW_TEXTURE
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature _ TCP2_OUTLINE_CONST_SIZE TCP2_OUTLINE_MIN_SIZE
			#pragma shader_feature _ TCP2_OUTLINE_TEXTURED_VERTEX TCP2_OUTLINE_TEXTURED_FRAGMENT
			#pragma shader_feature _ TCP2_OUTLINE_LIGHTING_MAIN TCP2_OUTLINE_LIGHTING_INDIRECT
			#pragma shader_feature _ TCP2_SHADOW_TEXTURE
